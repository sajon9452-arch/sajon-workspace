...
import { triggerNativeCall } from '../utils/nativeIntentHelper';
                ...
                <div className="flex flex-wrap items-center gap-2 flex-shrink-0">
                  {officialNumber && (
                    <>
                      ...
                      <button
                        type="button"
                        onClick={() => triggerNativeCall(officialNumber)}
                        className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-xl shadow-xs transition flex items-center gap-1.5 cursor-pointer active:scale-98"
                        title="অফিসিয়াল নম্বরে সরাসরি কল দিন"
                      >
              ...
              {patengaHelplines.map((item) => (
                ...
                >
                  ...
                  <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-end gap-1.5">
                    ...
                    <button
                      type="button"
                      onClick={() => triggerNativeCall(item.number)}
                      className="px-2.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-[11px] rounded-xl shadow-2xs transition flex items-center gap-1 cursor-pointer active:scale-98"
                      title="সরাসরি কল দিন"
                    >
                ...
                >
                  ...
                  <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-end gap-1.5">
                    ...
                    <button
                      type="button"
                      onClick={() => triggerNativeCall(item.number)}
                      className="px-2.5 py-1.5 bg-slate-900 hover:bg-black text-white font-bold text-[11px] rounded-xl shadow-2xs transition flex items-center gap-1 cursor-pointer active:scale-98"
                      title="সরাসরি কল দিন"
                    >
                      <Phone className="w-3 h-3" />
                      <span>কল করুন</span>
